...
export const PERMISSION_MODULES = [
    ...
    { key: 'point-submission', label: 'Input Poin', group: 'Manajemen Poin', actions: ['L', 'T', 'E', 'H'] },
    { key: 'point-submission.history', label: 'Riwayat Poin', group: 'Manajemen Poin', actions: ['L', 'T', 'E', 'H'] },
    { key: 'point-submission.request', label: 'Permintaan Penukaran', group: 'Manajemen Poin', actions: ['L', 'T', 'E'] },
    { key: 'point-adjustment', label: 'Penyesuaian Poin', group: 'Manajemen Poin', actions: ['L', 'T', 'E', 'H'] },
