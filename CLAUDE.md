...
- **24 feature modules** in `src/modules/` (auth, profile, user, employee, role, customer,
  ...
  statistic, additional, notification, branch, rate-commission).
...
- `src/config/database.ts` — AppDataSource + entity registry (41 entities)
